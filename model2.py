...
class sample_generator(nn.Module):
    def __init__(self):
        ...
        self.h1      = nn.ConvTranspose2d(in_channels=141, out_channels=pitch_range, kernel_size=(2,1), stride=(2,2))
        self.h2      = nn.ConvTranspose2d(in_channels=141, out_channels=pitch_range, kernel_size=(2,1), stride=(2,2))
        self.h3      = nn.ConvTranspose2d(in_channels=141, out_channels=pitch_range, kernel_size=(2,1), stride=(2,2))
